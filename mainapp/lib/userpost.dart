      ...
      body: WebViewWidget(
        controller: WebViewController()
          ...
          ..loadRequest(Uri.parse(
              //GASでスプレッドシートからデータを取り出してるのをhtmlにしてそれをflutterで表示してる
              //GASには直接入れる(write_screenで)
              "https://script.google.com/macros/s/AKfycbzlIsYY6jP7IkX9sB6VWXfL4IOsBaMUQyttGrTPx_kpZ7t4VlZoLMsGfFFku0Lu1g08og/exec")),
      ),
      appBar: AppBar(
